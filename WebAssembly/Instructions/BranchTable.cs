...
namespace WebAssembly.Instructions
{
	...
	internal sealed override void CompileIKVM(IKVMCompilationContext context, IKVM.Reflection.Universe universe)
	{
	    ...
	    var blockDepth = checked((uint)context.Depth.Count);
	    context.Emit(IKVM.Reflection.Emit.OpCodes.Switch, this.Labels.Select(index => context.Labels[blockDepth - index - 1]).ToArray());
	    context.Emit(IKVM.Reflection.Emit.OpCodes.Br, context.Labels[blockDepth - this.DefaultLabel - 1]);
	}
    }
}